...
class ModelTopic:
    ...
    def lda_model(self, num_topics):
        ...
        def format_topics_sentences(ldamodel=lda_model, corpus=doc_term_matrix, texts=texts):
            # Init output
        ...
        df_topic_sents_keywords = format_topics_sentences(ldamodel=lda_model, corpus=doc_term_matrix, texts=texts)
